# bcc-crypto.js
* [The-Blockchain-Company/bcc-crypto](https://github.com/The-Blockchain-Company/bcc-crypto/tree/master/cbits)
...
Compiled to pure javascript using Emscripten. This is a collection of cryptolibraries and functions useful for working with Bcc cryptocurrency, eliminating the need for many dependencies.

# Examples
## Signing

``` javascript
var lib = require('bcc-crypto.js')
...
* `Object getSophieAddressInfo(Buffer address)`
* `Object AddressTypes`
...
## Klarity paper wallets (27-word mnemonics)
...
source ./emsdk_env.sh
cd ../
git clone https://github.com/the-blockchain-company/bcc-crypto.js
cd bcc-crypto.js
npm install
npm run build
...
When trying to compile the library with emscripten 1.38.41, the `bccMemoryCombine` function slows down significantly. With the 1.38.8 version it runs significantly faster.

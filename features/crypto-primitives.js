...
// used for encoding/decoding seeds to JSON in Klarity
function bccMemoryCombine(input, password) {
  validateBuffer(input)
  ...
  Module._emscripten_bcc_memory_combine(transformedPasswordArrPtr, transformedPasswordLen, inputArrPtr, outputArrPtr, inputLen)

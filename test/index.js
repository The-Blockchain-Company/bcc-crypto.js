...
test('bccMemoryCombine', (t) => {
  ...
  t.equals(
    lib.bccMemoryCombine(input, password).toString('hex'),
    expectedOutput.toString('hex'),
    'should properly combine memory with nonempty passphrase'
  )

  t.equals(
    lib.bccMemoryCombine(input, '').toString('hex'),
    input.toString('hex'),
...
test('Sophie address validation', async (t) => {
  t.plan(3)
  t.equals(
    lib.isValidSophieAddress(sampleBaseAddress),
    true,
    'should accept Sophie base address'
  )
  t.equals(
    lib.isValidSophieAddress(sampleV1Address),
    false,
    'should reject bootstrap address'
  )
  t.equals(
    lib.isValidSophieAddress('garbage'),
    false,
...
test('address decoding to buffer', async (t) => {
  ...
  t.equals(
    ...
    'should properly decode sophie address'
  )
  ...
  t.equals(
    ...
    'should properly decode sophie script address'
  )
...
test('bootstrap address packing/unpacking', async (t) => {
  ...
  t.equals(
    ...
    1,
    'should properly get Klarity bootstrap address attributes'
  )
  t.equals(
    lib.getBootstrapAddressAttributes(
  ...
  t.equals(
    ...
    'should properly get Klarity bootstrap address derivation path'
  )
  t.equals(
  ...
  t.equals(
    ...
    mainnetProtocolMagic,
    'should properly get Klarity bootstrap mainnet address protocol magic'
  )
  t.equals(
    lib.getBootstrapAddressProtocolMagic(
      lib.addressToBuffer(expectedV1TestnetAddress),
    ...
    testnetProtocolMagic,
    'should properly get Klarity bootstrap testnet address protocol magic'
  )
})

test('sophie addresses', (t) => {
  t.plan(6)
  ...
  t.equals(
    ...
    'should properly decode address type from sophie address header'
  )
  t.equals(
    lib.getSophieAddressNetworkId(
      Buffer.from('439493315cd92eb5d8c4304e67b7e16ae36d61d34502694657811a2c8e81bc5d81312a', 'hex')
    ),
    3,
    'should properly decode address network id from sophie address header'
  )
})
